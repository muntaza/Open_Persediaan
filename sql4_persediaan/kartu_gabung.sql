...
DROP VIEW IF EXISTS view_kartu_barang3_bpmpd CASCADE;

CREATE VIEW view_kartu_barang3_bpmpd AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_bpmpd TO lap_bpmpd;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_bpmpd FROM lap_bpmpd;
DROP VIEW IF EXISTS view_kartu_barang3_bppakb CASCADE;

CREATE VIEW view_kartu_barang3_bppakb AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_bppakb TO lap_bppakb;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_bppakb FROM lap_bppakb;
...
DROP VIEW IF EXISTS view_kartu_barang3_disporaparbud CASCADE;

CREATE VIEW view_kartu_barang3_disporaparbud AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_disporaparbud TO lap_disporaparbud;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_disporaparbud FROM lap_disporaparbud;
DROP VIEW IF EXISTS view_kartu_barang3_dispu CASCADE;

CREATE VIEW view_kartu_barang3_dispu AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_dispu TO lap_dispu;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_dispu FROM lap_dispu;
DROP VIEW IF EXISTS view_kartu_barang3_distamben CASCADE;

CREATE VIEW view_kartu_barang3_distamben AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_distamben TO lap_distamben;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_distamben FROM lap_distamben;
DROP VIEW IF EXISTS view_kartu_barang3_dppkad CASCADE;

CREATE VIEW view_kartu_barang3_dppkad AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_dppkad TO lap_dppkad;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_dppkad FROM lap_dppkad;
...
DROP VIEW IF EXISTS view_kartu_barang3_kehutanan CASCADE;

CREATE VIEW view_kartu_barang3_kehutanan AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_kehutanan TO lap_kehutanan;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_kehutanan FROM lap_kehutanan;
...
DROP VIEW IF EXISTS view_kartu_barang3_korpri CASCADE;

CREATE VIEW view_kartu_barang3_korpri AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_korpri TO lap_korpri;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_korpri FROM lap_korpri;
DROP VIEW IF EXISTS view_kartu_barang3_kp2tpm CASCADE;

CREATE VIEW view_kartu_barang3_kp2tpm AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_kp2tpm TO lap_kp2tpm;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_kp2tpm FROM lap_kp2tpm;
...
DROP VIEW IF EXISTS view_kartu_barang3_paringintimur CASCADE;

CREATE VIEW view_kartu_barang3_paringintimur AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_paringintimur TO lap_paringintimur;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_paringintimur FROM lap_paringintimur;
DROP VIEW IF EXISTS view_kartu_barang3_perindagkop CASCADE;

CREATE VIEW view_kartu_barang3_perindagkop AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_perindagkop TO lap_perindagkop;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_perindagkop FROM lap_perindagkop;
...
DROP VIEW IF EXISTS view_kartu_barang3_rsud CASCADE;

CREATE VIEW view_kartu_barang3_rsud AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_rsud TO lap_rsud;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_rsud FROM lap_rsud;
...
DROP VIEW IF EXISTS view_kartu_barang3_snt CASCADE;

CREATE VIEW view_kartu_barang3_snt AS
...
GRANT ALL PRIVILEGES ON view_kartu_barang3_snt TO lap_snt;
REVOKE INSERT, UPDATE, DELETE ON view_kartu_barang3_snt FROM lap_snt;
