...
DROP VIEW IF EXISTS view_beban_barang3_korpri;

CREATE VIEW view_beban_barang3_korpri AS
...
GRANT ALL PRIVILEGES ON view_beban_barang3_korpri TO lap_korpri;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang3_korpri FROM lap_korpri;
...
DROP VIEW IF EXISTS view_beban_barang3_paringinkota;

CREATE VIEW view_beban_barang3_paringinkota AS
...
GRANT ALL PRIVILEGES ON view_beban_barang3_paringinkota TO lap_paringinkota;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang3_paringinkota FROM lap_paringinkota;
