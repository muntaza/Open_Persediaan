...
DROP VIEW IF EXISTS view_beban_barang5_batupiring CASCADE;

CREATE VIEW view_beban_barang5_batupiring AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_batupiring TO lap_batupiring;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_batupiring FROM lap_batupiring;
...
DROP VIEW IF EXISTS view_beban_barang5_bpmpd CASCADE;

CREATE VIEW view_beban_barang5_bpmpd AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_bpmpd TO lap_bpmpd;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_bpmpd FROM lap_bpmpd;
DROP VIEW IF EXISTS view_beban_barang5_bppakb CASCADE;

CREATE VIEW view_beban_barang5_bppakb AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_bppakb TO lap_bppakb;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_bppakb FROM lap_bppakb;
DROP VIEW IF EXISTS view_beban_barang5_bppkp CASCADE;

CREATE VIEW view_beban_barang5_bppkp AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_bppkp TO lap_bppkp;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_bppkp FROM lap_bppkp;
...
DROP VIEW IF EXISTS view_beban_barang5_disporaparbud CASCADE;

CREATE VIEW view_beban_barang5_disporaparbud AS
...
FROM
view_beban_barang4_disporaparbud
...
GRANT ALL PRIVILEGES ON view_beban_barang5_disporaparbud TO lap_disporaparbud;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_disporaparbud FROM lap_disporaparbud;
...
DROP VIEW IF EXISTS view_beban_barang5_dppkad CASCADE;

CREATE VIEW view_beban_barang5_dppkad AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_dppkad TO lap_dppkad;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_dppkad FROM lap_dppkad;
...
DROP VIEW IF EXISTS view_beban_barang5_kehutanan CASCADE;

CREATE VIEW view_beban_barang5_kehutanan AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_kehutanan TO lap_kehutanan;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_kehutanan FROM lap_kehutanan;
...
DROP VIEW IF EXISTS view_beban_barang5_korpri CASCADE;

CREATE VIEW view_beban_barang5_korpri AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_korpri TO lap_korpri;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_korpri FROM lap_korpri;
DROP VIEW IF EXISTS view_beban_barang5_kp2tpm CASCADE;

CREATE VIEW view_beban_barang5_kp2tpm AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_kp2tpm TO lap_kp2tpm;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_kp2tpm FROM lap_kp2tpm;
...
DROP VIEW IF EXISTS view_beban_barang5_paringinkota CASCADE;

CREATE VIEW view_beban_barang5_paringinkota AS
...
FROM
view_beban_barang4_paringinkota
...
GRANT ALL PRIVILEGES ON view_beban_barang5_paringinkota TO lap_paringinkota;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_paringinkota FROM lap_paringinkota;
...
DROP VIEW IF EXISTS view_beban_barang5_paringintimur CASCADE;

CREATE VIEW view_beban_barang5_paringintimur AS
...
FROM
view_beban_barang4_paringintimur
...
GRANT ALL PRIVILEGES ON view_beban_barang5_paringintimur TO lap_paringintimur;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_paringintimur FROM lap_paringintimur;
DROP VIEW IF EXISTS view_beban_barang5_perindagkop CASCADE;

CREATE VIEW view_beban_barang5_perindagkop AS
...
FROM
view_beban_barang4_perindagkop
...
GRANT ALL PRIVILEGES ON view_beban_barang5_perindagkop TO lap_perindagkop;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_perindagkop FROM lap_perindagkop;
...
DROP VIEW IF EXISTS view_beban_barang5_rsud CASCADE;

CREATE VIEW view_beban_barang5_rsud AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_rsud TO lap_rsud;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_rsud FROM lap_rsud;
...
DROP VIEW IF EXISTS view_beban_barang5_snt CASCADE;

CREATE VIEW view_beban_barang5_snt AS
...
GRANT ALL PRIVILEGES ON view_beban_barang5_snt TO lap_snt;
REVOKE INSERT, UPDATE, DELETE ON view_beban_barang5_snt FROM lap_snt;
