...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_bkppd TO lap_bkppd;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_bkppd FROM lap_bkppd;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_bppd;

CREATE VIEW view_buku_pengeluaran_bppd AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_bppd TO lap_bppd;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_bppd FROM lap_bppd;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_disnakertrans;

CREATE VIEW view_buku_pengeluaran_disnakertrans AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_disnakertrans TO lap_disnakertrans;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_disnakertrans FROM lap_disnakertrans;
DROP VIEW IF EXISTS view_buku_pengeluaran_dko;

CREATE VIEW view_buku_pengeluaran_dko AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dko TO lap_dko;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dko FROM lap_dko;
DROP VIEW IF EXISTS view_buku_pengeluaran_dkp;

CREATE VIEW view_buku_pengeluaran_dkp AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dkp TO lap_dkp;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dkp FROM lap_dkp;
DROP VIEW IF EXISTS view_buku_pengeluaran_dkukmp;

CREATE VIEW view_buku_pengeluaran_dkukmp AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dkukmp TO lap_dkukmp;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dkukmp FROM lap_dkukmp;
DROP VIEW IF EXISTS view_buku_pengeluaran_dlh;

CREATE VIEW view_buku_pengeluaran_dlh AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dlh TO lap_dlh;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dlh FROM lap_dlh;
DROP VIEW IF EXISTS view_buku_pengeluaran_dpkp;

CREATE VIEW view_buku_pengeluaran_dpkp AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dpkp TO lap_dpkp;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dpkp FROM lap_dpkp;
DROP VIEW IF EXISTS view_buku_pengeluaran_dpmd;

CREATE VIEW view_buku_pengeluaran_dpmd AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dpmd TO lap_dpmd;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dpmd FROM lap_dpmd;
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dpmptsp TO lap_dpmptsp;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dpmptsp FROM lap_dpmptsp;
DROP VIEW IF EXISTS view_buku_pengeluaran_dppkb;

CREATE VIEW view_buku_pengeluaran_dppkb AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dppkb TO lap_dppkb;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dppkb FROM lap_dppkb;
DROP VIEW IF EXISTS view_buku_pengeluaran_dpppa;

CREATE VIEW view_buku_pengeluaran_dpppa AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dpppa TO lap_dpppa;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dpppa FROM lap_dpppa;
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_dpupr TO lap_dpupr;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_dpupr FROM lap_dpupr;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_kearsipan;

CREATE VIEW view_buku_pengeluaran_kearsipan AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_kearsipan TO lap_kearsipan;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_kearsipan FROM lap_kearsipan;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_kominfo;

CREATE VIEW view_buku_pengeluaran_kominfo AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_kominfo TO lap_kominfo;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_kominfo FROM lap_kominfo;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_pariwisata;

CREATE VIEW view_buku_pengeluaran_pariwisata AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_pariwisata TO lap_pariwisata;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_pariwisata FROM lap_pariwisata;
DROP VIEW IF EXISTS view_buku_pengeluaran_perdagangan;

CREATE VIEW view_buku_pengeluaran_perdagangan AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_perdagangan TO lap_perdagangan;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_perdagangan FROM lap_perdagangan;
DROP VIEW IF EXISTS view_buku_pengeluaran_perikanan;

CREATE VIEW view_buku_pengeluaran_perikanan AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_perikanan TO lap_perikanan;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_perikanan FROM lap_perikanan;
DROP VIEW IF EXISTS view_buku_pengeluaran_perpustakaan;

CREATE VIEW view_buku_pengeluaran_perpustakaan AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_perpustakaan TO lap_perpustakaan;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_perpustakaan FROM lap_perpustakaan;
...
DROP VIEW IF EXISTS view_buku_pengeluaran_sosial;

CREATE VIEW view_buku_pengeluaran_sosial AS
...
GRANT ALL PRIVILEGES ON view_buku_pengeluaran_sosial TO lap_sosial;
REVOKE INSERT, UPDATE, DELETE ON view_buku_pengeluaran_sosial FROM lap_sosial;
